...
ucs_status_t uct_cuda_copy_ep_put_short(uct_ep_h tl_ep, const void *buffer, unsigned length, 
                                   uint64_t remote_addr, uct_rkey_t rkey);
ucs_status_t uct_cuda_copy_ep_am_short(uct_ep_h ep, uint8_t id, uint64_t header,
